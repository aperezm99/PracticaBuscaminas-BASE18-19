...
/**
 * Metodo encargargado de inicializar los botones que contienen "Minas"
 * 
 */
			...
			for (int j = 0; j < 10; j++) {
				...
				botonesJuego[i][j].addMouseListener(new MouseAdapter() {
					...
					public void mouseClicked(MouseEvent e) {
						if (e.isMetaDown()) {
							if (botonesJuego[contadori][contadorj].getText() == "-") {
	...
	public void mostrarFinJuego(boolean porExplosion) {
		if (porExplosion == true) {
			...
			JOptionPane.showMessageDialog(ventana, "Ha explotado una mina!!", "Fin de juego",
